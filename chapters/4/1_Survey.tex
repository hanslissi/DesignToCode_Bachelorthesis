...
small, the results are qualitative and provide a solid foundation to build upon.
...
These results suggest that there is a common ground for persisting issues, working with components
is not yet fully compatible between the two disciplines.
